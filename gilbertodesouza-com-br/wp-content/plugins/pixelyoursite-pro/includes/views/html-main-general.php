...
?>
    ...
    <div class="panel">
        ...
        <div class="row mb-3">
            <div class="col">
                <a href="https://www.youtube.com/watch?v=2oRF4LKaMaw" target="_blank">WooCommerce: track PURCHASE source
                    (7:56) - wath now</a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col form-inline">
                ...
                <label>day(s)</label>
                <small class="mt-1">We use cookies to store the <i>landing page, traffic source, and UTMs</i>. All
                    events fired in this interval will report these values. Cookie's name: <i>pysTrafficSource,
                        pys_landing_page, pys_utm_name</i></small>
